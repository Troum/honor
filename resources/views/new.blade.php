...
@section('content')
    <div class="container-fluid m-xl-0 p-xl-0">
        <div class="row m-xl-0 p-xl-0" data-one>
                            ...
                            <div class="collapse navbar-collapse">
                                <ul class="navbar-nav ml-xl-auto" data-nav>
                                    <li class="nav-item pr-xl-1 pl-xl-2">
                                        <a class="nav-link text-white p-xl-0" href="#" style="font-size: large" data-to="rule">Правила</a>
                                    </li>
                                    <li class="nav-item pr-xl-1 pl-xl-2">
        ...
        <div class="row m-xl-0 p-xl-0 d-flex align-content-center position-relative" data-two data-rule>
            <div class="col-xl-12 m-xl-0 p-xl-0">
        ...
        <div class="row m-xl-0 p-xl-0 d-flex align-content-center position-relative" data-three data-register>
            ...
            <div class="col-xl-8 mx-auto mt-xl-2 p-xl-0">
                <div class="row m-0 p-0">
        ...
        <div class="row m-xl-0 p-xl-0 d-flex align-content-center position-relative" data-five data-feedback>
            ...
            <div class="col-xl-12 m-0 p-0 align-self-center position-absolute text-center footer" style="z-index: 0">
                <img src="{{asset('assets/images/footer.png')}}" class="img-fluid" alt="">
            </div>
            <div class="col-xl-12 m-0 p-0 align-self-center position-absolute text-center navbar-footer" style="z-index: 3">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavFooter">
                        <ul class="navbar-nav mx-xl-auto">
                            <li class="nav-item pr-xl-2 pl-xl-2">
                                <a class="nav-link text-white" href="#" style="font-size: large" data-to="rule">Правила</a>
                            </li>
                            <li class="nav-item pr-xl-2 pl-xl-2">
            ...
            <div class="col-xl-12 m-0 p-0 align-self-center position-absolute text-center text-white footer-info" style="z-index: 1">
